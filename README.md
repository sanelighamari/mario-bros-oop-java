...
> **Note:** This branch contains the **extended, solo-developed version** of the engine. To view the original university coursework developed in pairs, please visit the [base branch](https://github.com/sanelighamari/mario-bros-oop-java/tree/legacy-base).
