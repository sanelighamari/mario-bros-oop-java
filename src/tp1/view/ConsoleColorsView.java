...
public class ConsoleColorsView extends ConsoleView {
	...
	private static final String BOX_TEXT = ConsoleColorsAnsiCodes.ANSI_WHITE + MyStringUtils.center(Messages.BOX, CELL_SIZE);
	private static final String BOX_CELL = COLOR_BOX_BACKGROUND + BOX_TEXT + ConsoleColorsAnsiCodes.ANSI_RESET;
	private static final String EMPTY_BOX_TEXT = ConsoleColorsAnsiCodes.ANSI_WHITE + MyStringUtils.center(Messages.EMPTY_BOX, CELL_SIZE);
